...
public class DbHelper {
    ...
    public ArrayList<Record> SimpleModels(){
        ArrayList<Record> simpleDB = new ArrayList<Record>();
        ...
        simpleDB.add(new Record("7", R.drawable.volkswagen_touareg_icon, R.drawable.volkswagen_touareg, "Volkswagen Touareg", "3.0", "249", "4 369 000", R.string.volkswagen_touareg_desc));
    ...
    public class Record {
        ...
        public Record(String ID, int iconID, int imageID, String model, String engineVolume, String enginePower, String cost, int descID) {
            this.ID = ID;
            this.iconID = iconID;
